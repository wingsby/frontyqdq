...
var GuildWarBattleSwitcher = (function () {
    function GuildWarBattleSwitcher() {
        this.type = battle.E_BATTLE_TYPE.GUILD;
    ...
    GuildWarBattleSwitcher.prototype.toPve = function () {
        // 切换关卡背景
    ...
    return GuildWarBattleSwitcher;
}());
__reflect(GuildWarBattleSwitcher.prototype, "GuildWarBattleSwitcher", ["battle.IBattleSwitcher"]);
//# sourceMappingURL=GuildWarBattleSwitcher.js.map