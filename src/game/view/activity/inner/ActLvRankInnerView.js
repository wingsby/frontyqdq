...
var ui;
(function (ui) {
    var ActLvRankInnerView = (function (_super) {
        __extends(ActLvRankInnerView, _super);
        /**
         * @constructor
         */
        function ActLvRankInnerView() {
         ...
         * 设定视图数据
         */
        ActLvRankInnerView.prototype.initView = function () {
            _super.prototype.initView.call(this);
            var entries = [];
            var cfg_lvs = Template.hdRankingLv.values;
            for (var i = 1; i <= cfg_lvs.length; i++) {
                ...
                n.context = {
                    ...
                    mark: "",
                    rank: cfg.rank[0],
                    rank_type: RankListType.TEAM_LV
                };
                // 设置回调
                n.callback = function () { };
                n.thisObj = this;
                // 活动开启天数
                var start_time = ActivityUtil.getActStartTime(E_ACT_DESIGN_TYPE.LvRank, E_ACT_TYPE.BEGIN);
         ...
         * 响应添加到舞台
         */
        ActLvRankInnerView.prototype.onAddToStage = function () {
            this.initView();
        };
        return ActLvRankInnerView;
    }(ui.ActInnerBasicView));
    ui.ActLvRankInnerView = ActLvRankInnerView;
    __reflect(ActLvRankInnerView.prototype, "ui.ActLvRankInnerView");
})(ui || (ui = {}));
//# sourceMappingURL=ActLvRankInnerView.js.map