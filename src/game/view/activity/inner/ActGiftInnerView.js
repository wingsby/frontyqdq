...
var ui;
(function (ui) {
    var ActGiftInnerView = (function (_super) {
        __extends(ActGiftInnerView, _super);
        /**
         * @constructor
         */
        function ActGiftInnerView() {
         ...
         * 设定视图数据
         */
        ActGiftInnerView.prototype.initView = function () {
            var _this = this;
            ...
            var _loop_1 = function (i) {
                var cfg = cfg_gift[i];
                if (cfg.Type != E_GIFT_TYPE.NORMAL) {
                    return "continue";
                }
                // 基本信息
                ...
                n.status = info.getItemStatus_Gift(cfg.ID);
                n.context = {
                    title: Template.getGUIText(cfg_item.iName) + Template.getGUIText("ui_shop" + discount),
                    mark: UtilsGame.stringHander(Template.getGUIText("ui_pve_52"), info.getItemBuyCount_Gift(cfg.ID), cfg.Next),
                ...
                // 设置回调
                n.callback = function () {
                    if (info.getItemStatus_Gift(cfg.ID) == E_REWARD_STATUS.AVAILABLE) {
                        Singleton.Get(ActivityManager).reqBuy_Gift(cfg.ID, function () {
                            _this.refresh();
        ...
        return ActGiftInnerView;
    }(ui.ActInnerBasicView));
    ui.ActGiftInnerView = ActGiftInnerView;
    __reflect(ActGiftInnerView.prototype, "ui.ActGiftInnerView");
})(ui || (ui = {}));
//# sourceMappingURL=ActGiftInnerView.js.map