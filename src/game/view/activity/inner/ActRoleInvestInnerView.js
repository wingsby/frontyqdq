...
var ui;
(function (ui) {
    var ActRoleInvestInnerView = (function (_super) {
        __extends(ActRoleInvestInnerView, _super);
        function ActRoleInvestInnerView() {
            var _this = _super.call(this) || this;
            _this.m_act_id = E_ACT_DESIGN_TYPE.RoleInvest;
            return _this;
        }
        ActRoleInvestInnerView.prototype.initInfo = function () {
            _super.prototype.initInfo.call(this);
            // 标题图片
            ResManager.AsyncSetTexture(this.imgInvest, "new_pidda1_png");
            // 消耗按钮内容
            this.initPrice(Template.config.InvestRole[1]);
            // 是否已购买显示状态
            this.initBuy(Singleton.Get(ActivityManager).getInfo().role_has_invest);
        };
        ActRoleInvestInnerView.prototype.initView = function () {
            var _this = this;
            _super.prototype.initView.call(this);
            var info = Singleton.Get(ActivityManager).getInfo();
            var entries = [];
            var tab_invest_vip = info.getEntities_RoleInvest();
            ...
            var _loop_1 = function (i) {
                ...
                n.item_id = cfg.ID;
                // 领取按钮状态
                var status_1 = info.getRewardStatus_RoleInvest(cfg.ID);
                n.status = status_1;
                // 数据信息
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                if (!(info.getRewardStatus_RoleInvest(cfg.ID) == E_REWARD_STATUS.AVAILABLE))
                                    return [3 /*break*/, 2];
                                return [4 /*yield*/, Singleton.Get(ActivityManager).reqReward_RoleInvest(cfg.ID)];
                            case 1:
                                _a.sent();
                                this.refresh();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            need_vip = Template.config.InvestRole[0];
                            price = Template.config.InvestRole[1];
                            ...
                            return [4 /*yield*/, Singleton.Get(ActivityManager).reqBuy_RoleInvest()];
                        case 2:
                            _a.sent();
        ...
        return ActRoleInvestInnerView;
    }(ui.ActInnerInvestBasicView));
    ui.ActRoleInvestInnerView = ActRoleInvestInnerView;
    __reflect(ActRoleInvestInnerView.prototype, "ui.ActRoleInvestInnerView");
})(ui || (ui = {}));
//# sourceMappingURL=ActRoleInvestInnerView.js.map