...
var ui;
(function (ui) {
    var SkillLabel = (function (_super) {
        __extends(SkillLabel, _super);
        /**
         * 构造函数
         */
        function SkillLabel(text) {
         ...
         * 播放弹出动画
         */
        SkillLabel.prototype.playPopTween = function (callback, thisObj) {
            var _this = this;
            this.text = this.text;
            this.alpha = 0;
            this.x = this.offX;
            ...
            tw.to({
                ...
                ObjectPool.getPool(SkillLabel).recycleObject(_this);
            }, this);
        };
        return SkillLabel;
    }(ui.UIBattleLabel));
    ui.SkillLabel = SkillLabel;
    __reflect(SkillLabel.prototype, "ui.SkillLabel");
})(ui || (ui = {}));
//# sourceMappingURL=SkillLabel.js.map