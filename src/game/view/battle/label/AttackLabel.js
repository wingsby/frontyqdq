...
var ui;
(function (ui) {
    var AttackLabel = (function (_super) {
        __extends(AttackLabel, _super);
        /**
         * 构造函数
         */
        function AttackLabel(text) {
            ...
            // this.font = RES.getxxxRes("attack_fnt");
            ResManager.getResAsync("attack_fnt", function (res) { _this.font = res; }, _this);
            return _this;
        }
        /**
         * 播放弹出动画
         */
        AttackLabel.prototype.playPopTween = function (callback, thisObj) {
            var _this = this;
            this.alpha = 0;
            this.x = this.offX;
            this.y = this.offY;
            ...
            tw
                ...
                ObjectPool.getPool(AttackLabel).recycleObject(_this);
            }, this);
        };
        return AttackLabel;
    }(ui.UIBattleLabel));
    ui.AttackLabel = AttackLabel;
    __reflect(AttackLabel.prototype, "ui.AttackLabel");
})(ui || (ui = {}));
//# sourceMappingURL=AttackLabel.js.map