...
var ui;
(function (ui) {
    var PursuedLabel = (function (_super) {
        __extends(PursuedLabel, _super);
        /**
         * 构造函数
         */
        function PursuedLabel(text) {
         ...
         * 播放弹出动画
         */
        PursuedLabel.prototype.playPopTween = function (callback, thisObj) {
            var _this = this;
            ...
            tw
                ...
                ObjectPool.getPool(PursuedLabel).recycleObject(_this);
            }, this);
        };
        return PursuedLabel;
    }(ui.UIBattleLabel));
    ui.PursuedLabel = PursuedLabel;
    __reflect(PursuedLabel.prototype, "ui.PursuedLabel");
})(ui || (ui = {}));
//# sourceMappingURL=PursuedLabel.js.map