...
var ui;
(function (ui) {
    var HealLabel = (function (_super) {
        __extends(HealLabel, _super);
        /**
         * 构造函数
         */
        function HealLabel(text) {
            ...
            ResManager.getResAsync("heal_fnt", function (res) { _this.font = res; }, _this);
            return _this;
        }
        /**
         * 播放弹出动画
         */
        HealLabel.prototype.playPopTween = function (callback, thisObj) {
            var _this = this;
            ...
            tw
                ...
                ObjectPool.getPool(HealLabel).recycleObject(_this);
            }, this);
        };
        return HealLabel;
    }(ui.UIBattleLabel));
    ui.HealLabel = HealLabel;
    __reflect(HealLabel.prototype, "ui.HealLabel");
})(ui || (ui = {}));
//# sourceMappingURL=HealLabel.js.map